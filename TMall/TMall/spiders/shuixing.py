...
class TmallSpider(CrawlSpider):
    ...
    def __init__(self):
        ...
        self.start_urls = ['https://shuixing.tmall.com/']
    ...
    def parse(self, response):
        ...
        for page in xrange(self.start_page, self.end_page+1):     # NOTE: 此处url会发生变化
            url = 'https://shuixing.tmall.com/i/asynSearch.htm?_ksTS=1495473944678_392&callback=jsonp393&mid=w-14438749695-0&wid=14438749695&path=/search.htm&&search=y&spm=a1z10.3-b-s.w4011-14438749695.386.KjbYWA&scene=taobao_shop&pageNo={}&tsearch=y'.format(page)
